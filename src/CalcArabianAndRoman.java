...
public class CalcArabianAndRoman {
    public static void main(String[] args) throws Exception {
        Scanner scanner = new Scanner(System.in);
        System.out.println("Введите 2 числа от 1 до 10 (арабские или римские), используя плюс, минус, деление или умножение: ");
        ...
        if (actionIndex == -1) throw new Exception("Некоректное выражение");

        //Сплитуем выражение и проверяем сколько чисел в нем находится
        String[] operands = expression.split(regexActions[actionIndex]); //Делим (сплитуем) выражение по нашему недавнему найденному индексу (actionIndex), но уже из массива regexActions
        ...
        //Если оба числа арабские
            ...
            resultArabian = String.valueOf(result);
